...
const desktopUrls = {
  windows:
    'https://github.com/celo-tools/celo-web-wallet/releases/download/v1.7.1/Celo-Wallet-1.7.1-win-x64.exe',
  mac: 'https://github.com/celo-tools/celo-web-wallet/releases/download/v1.7.1/Celo-Wallet-1.7.1-mac.dmg',
  linux:
    'https://github.com/celo-tools/celo-web-wallet/releases/download/v1.7.1/Celo-Wallet-1.7.1-linux-x86_64.AppImage',
};

// eslint-disable-next-line @typescript-eslint/no-unused-vars
const configMainnet: CeloConfig = {
  // debug: debugMode,
  // isElectron,
  // version,
  // alchemyApiKey,
  ...
  jsonRpcUrlSecondary: 'https://rpc.ankr.com/celo',
  ...
  contractAddresses: {
    ...
    [CeloContract.GasPriceMinimum]:
      '0xDfca3a8d7699D8bAfe656823AD60C17cb8270ECC',
    ...
    [CeloContract.USDTet]: '0x617f3112bf5397D0467D315cC709EF968D9ba546',
    [CeloContract.USDC]: '0x37f750b7cc259a2f741af45294f6a16572cf5cad',
    [CeloContract.USDCPool]: '0xea3fb6e3313a2a90757e4ca3d6749efd0107b0b6',
    [CeloContract.WrappedBTC]: '0xD629eb00dEced2a080B7EC630eF6aC117e614f1b',
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
const configAlfajores: CeloConfig = {
  // debug: true,
  // isElectron,
  // version,
  // alchemyApiKey,
  ...
  contractAddresses: {
    ...
    [CeloContract.GasPriceMinimum]:
      '0xd0Bf87a5936ee17014a057143a494Dc5C5d51E5e',
    ...
    [CeloContract.USDTet]: '0x24c3a1aa033b2d126b9ae7e52787c8c7afc3fa7a',
    [CeloContract.USDC]: '0x64462cbb8ebd01f895daedc7d54f0998372af5cd',
    [CeloContract.USDCPool]: '0xea3fb6e3313a2a90757e4ca3d6749efd0107b0b6',
    [CeloContract.WrappedBTC]: '0x73b16c87d01dd9c70f9451e96a97ab5a41196f66',
...
export const CeloMainnetConfig = Object.freeze(configMainnet);
export const CeloAlfajoresConfig = Object.freeze(configAlfajores);
